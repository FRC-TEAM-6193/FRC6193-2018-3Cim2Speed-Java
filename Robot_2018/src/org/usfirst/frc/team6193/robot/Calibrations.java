...
public class Calibrations {
	...
	public static double[] k_DrivelineSpeedHiGearTable_InchPerSec = {0,10,10,10,30,50,70,91.5,113.5,140.0,156.0};
	public static double k_DrivelineEncoderRatio_CntPerInch = 404;
	public static double k_drivelineAutoDriveRotateComp = 0.1;
